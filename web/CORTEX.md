...
| `src/features/workbench/` | **App-shell frame + 22a dual-zone Left Rail + Center Chat + Right Panel** — includes the shared context bar/modal and manual Compact action above chat composers. `LeftRail` uses the dual-zone projects/sessions scheme with live attention state. See its CORTEX.md |
