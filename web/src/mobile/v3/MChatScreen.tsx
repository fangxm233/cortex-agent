...
const COPY: { en: MChatCopy; zh: MChatCopy } = {
  zh: {
    ...
    selectionHiddenModels: '另有 {n} 个模型本会话不可用',
    selectionHiddenProfiles: '另有 {n} 个 profile 本会话不可用',
    selectionHiddenNoProfile: '另有 {n} 个模型没有可用 profile',
  ...
  en: {
    ...
    selectionHiddenModels: '{n} more models not available this session',
    selectionHiddenProfiles: '{n} more profiles not available this session',
    selectionHiddenNoProfile: '{n} more models have no available profile',
