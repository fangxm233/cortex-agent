...
|---|---|---|
| AGENTS.md | index | Index mobile screen files |
...
| MMemoryFileView.tsx | view | Render memory file content and metadata |
| m-memory-file-vm.ts | utility | Format memory file names and metadata |
| MMemoryScreen.tsx | screen | Connect memory browsing data and actions |
| MMemoryView.tsx | view | Render mobile memory browser |
| m-memory-vm.test.ts | test | Test memory view model construction |
| m-memory-vm.ts | model | Build mobile memory browser state |
| MNativeNotificationsCard.test.tsx | test | Test native notification controls |
| MNativeNotificationsCard.tsx | view | Control device-local background notifications |
...
| m-settings-vm.test.ts | test | Test settings view model construction |
| m-settings-vm.ts | model | Build mobile settings overview state |
| MTaskDetailScreen.tsx | screen | Connect task detail data and actions |
| MTaskDetailView.tsx | view | Render mobile task details |
