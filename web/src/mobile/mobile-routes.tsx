...
// drill-in sub-screens (1b/1f/1g/1h/1i/1j/1j-file/1k/1l/1r) which hide the Tab bar (see mobile-tabs
// isTabRoute; `/m/memory/file` maps to the 项目 tab via the `/m/memory` prefix).
