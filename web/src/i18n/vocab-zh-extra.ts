...
export const zhExtra = {
  ...
  rpCollapsePanel: '折叠右侧面板',
  rpExpandPanel: '展开右侧面板',
  rpPanelNavigation: '右侧面板',
  lrCollapseRail: '折叠侧边栏',
  lrExpandRail: '展开侧边栏',
  lrRailNavigation: '侧边栏',
  ...
  usagePolicyDefaultPrefix: '默认',
  usagePolicyUsingLegacy: '正在使用旧版兜底',
  usagePolicyLegacyTitle: '旧版兜底',
  ...
  stAdvPiCompactTitle: 'PI turn 内压缩阈值（%）',
  stAdvPiCompactDesc: '仅 PI · 上下文占用超过该比例时在 turn 中途压缩 · 0 表示关闭',
  stAdvPiCompactInvalid: '请输入 0（关闭）或范围内的整数百分比',
  ...
  authLoginOpenStep: '打开授权页面',
  authLoginOpenAuthorization: '前往授权',
  authLoginCodeStep: '粘贴授权码',
  authLoginCodePlaceholder: '在此粘贴授权码',
  authLoginAuthorizationSequence: '先打开授权页面，再粘贴授权码。',
  ...
  accountsSyncModelsHint: '重新检测已登录后端提供的模型，并刷新 profiles。',
