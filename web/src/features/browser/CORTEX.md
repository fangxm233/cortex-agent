...
The docked browser previews local or forwarded HTTP services with titled, sortable tabs.

| filename | role | function |
|---|---|---|
| WebBody.tsx | view | Renders titled tabs, forward sources and browser controls |
...
| browser-target.ts | vm | Models URLs, titles, forwards and ordered tabs |
