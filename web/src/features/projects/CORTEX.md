...
|---|---|---|
| CurrentProjectProvider.tsx | provider | Owns effective selection and exposes the listed projects |
| CurrentProjectProvider.test.tsx | test | Verifies project listing, derivation and sticky explicit selection |
