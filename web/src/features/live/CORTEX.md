...
|---|---|---|
| `workbench/useSessionMessageLiveSync` | session.message / status / turn / interaction / rewound | `{ sessionId }` — the open chat |
