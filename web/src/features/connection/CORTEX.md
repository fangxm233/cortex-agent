...
| `connection-status.test.ts` | Pure behavior tests for transport-state derivation, pulse policy, and localization-key mapping; palette values are not asserted. |
