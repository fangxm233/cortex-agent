// input:  a cached transcript and a server response that may be a delta
// output: a whole transcript, whichever form the response took
// pos:    Client half of the cursor-based transcript protocol
