// input:  running state and formatted status text
// output: desktop composer status row (pulse dot + meta text)
...
export function ComposerStatusLine({ running, text }: ComposerStatusLineProps): JSX.Element {
  return (
