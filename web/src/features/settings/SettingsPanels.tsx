...
// ProfilesPanel used to live here; it owns writes now (create / edit / delete) and moved to its own
// module, next to BudgetPanel and HooksPanel — see ProfilesPanel.tsx.
