...
|---|---|---|
| `src/dto.ts` | types | Type-only ui-service DTO re-exports, including session context usage, thread run/subtask activity, chat notices, DEBUG details, and durable pending rows |
