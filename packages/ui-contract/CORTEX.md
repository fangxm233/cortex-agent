...
|---|---|---|
| `src/dto.ts` | types | Type-only re-export of ui-service DTOs, including DEBUG details and durable pending transcript rows, plus mapped query/mutation contracts |
