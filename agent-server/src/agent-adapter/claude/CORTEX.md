...
|---|---|---|
| adapter.ts | adapter | runs turns with immutable accounting snapshots |
...
| jsonl-tail.ts | core | normalizes Claude transcript events and models |
| tmux-control.ts | util | wraps tmux with private temporary staging |
