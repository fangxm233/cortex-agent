...
Per-area message tables for the i18n layer, one file per feature cluster.
Each file carries the English and Simplified Chinese text for that cluster.
...
| status.ts | data | status, auth expiry, lifecycle and notice labels |
