...
| prompt-migration-replacements.ts | config | Defines independent prompt policy replacements |
| version-migrations.ts | startup | Migrates config, prompts, and hook collisions |
