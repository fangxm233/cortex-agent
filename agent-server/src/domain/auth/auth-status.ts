// input:  Claude/PI credentials, profiles, and localized copy
// output: AuthStatusSnapshot types, reader, and safe summary
// pos:    Backend authentication status normalizer
