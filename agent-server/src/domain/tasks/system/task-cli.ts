  ...
  commandGroups: [
    ...
    },
    {
      ...
      commands: [
        ...
        { name: 'pending', description: 'Mark pending (waiting on work outside this turn)' },
        { name: 'reopen', description: 'Restore a stuck pending task back to open (e.g. the awaited work never reported)' },
