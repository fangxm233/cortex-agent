...
| engines.ts | core | SessionEngines — the one owner of pooled engine sessions (acquire/close/kill/closeByPrefix/closeAll/registerSessionPath); module singleton `engines` + transitional PI run adapter |
