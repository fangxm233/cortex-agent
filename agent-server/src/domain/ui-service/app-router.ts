...
function sessionsRouter(service: UiService) {
  return router({
    ...
    subagentTranscript: makeQuery(service, 'sessions.subagentTranscript', sessionsSubagentTranscriptInput),
    ...
    markManyRead: makeMutation(service, 'sessions.markManyRead', sessionsMarkManyReadInput),
...
function systemRouter(service: UiService) {
  return router({
    ...
    notices: makeQuery(service, 'system.notices', systemNoticesInput),
