...
| composite-runtime-ports.ts | 类型 | 冻结 23 端口 bundle，未绑定抛 31 号 |
| trial-task-mutator.ts | 核心 | 修正后的 P3 能力感知任务变更器 |
...
| task-broker.ts | 核心 | 执行十动作授权、类型化拒绝与隔离任务投影 |
...
| trial-task-dispatcher.ts | 核心 | 试验内调度：选任务、铸造代次、组装提示 |
