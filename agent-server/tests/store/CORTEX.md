...
| hook-registry.test.ts | test | Covers hook schema, shipped defaults and filtering |
...
| session-hook-migration.test.ts | test | Covers legacy session hook registry migration |
