// input:  PIAdapter spawn + stub child process emitting message_update text_delta lines
// output: assistant_delta streaming assertions (per-delta emission, shared blockId, kill switch)
// pos:    PI streaming producer regression (hermetic, stub spawner)
