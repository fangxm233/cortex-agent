...
| benchmark-local-thread-orchestrator.test.ts | test | proves C9 lifecycle, containment and C4 identity projection |
...
| role-surface.test.ts | test | verifies directive/plugin hashing and argv alignment |
