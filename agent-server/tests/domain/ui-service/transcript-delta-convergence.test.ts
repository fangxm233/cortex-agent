// input:  a real history repo driven through every row-mutating append
// output: proof that replayed deltas equal the whole transcript
// pos:    End-to-end guard for the transcript delta protocol
