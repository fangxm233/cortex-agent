...
| agent-adapter-pi-hook-registry.test.ts | test | PI native contracts and interaction dispatch |
...
| hook-callers.test.ts | test | HookBus thread and registry session event handling |
