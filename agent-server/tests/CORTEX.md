...
| agent-adapter-pi-tool-shims.test.ts | test | PI pseudo-tools, web gates, retries, extension UI |
| agent-adapter-pi-web-search.test.ts | test | PI WebSearch dispatch, provenance and fallback |
