// input:  terminal results, channels, runtime settings
// output: hold-gate and channel-scope tests
// pos:    Covers which turns are held for their background phase, and by which surface
