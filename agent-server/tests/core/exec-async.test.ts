// input:  core/exec-async runFile/runShell
// output: exit-code, timeout, stdin and failure-mode contract tests
// pos:    Pins the async subprocess runner that replaced hot-path execSync calls
