...
| engine-spec.test.ts | test | buildEngineSpec/specToSpawnConfig exact round-trip against captured pre-refactor output, and engineIdentity key-order stability plus its three exclusions |
