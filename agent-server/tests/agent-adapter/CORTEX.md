...
| `pi-context-usage-probe.test.ts` | Test | PI `get_session_stats` request correlation, terminal ordering, timeout release, write-failure degradation, and close cancellation |
