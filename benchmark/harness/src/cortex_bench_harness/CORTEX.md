...
| campaign.py | CLI | Runs campaigns, resumes terminal outcomes and reports every trial |
...
| vendor_agents.py | adapter | Runs and finalizes pinned vendor CLIs with dummy configuration |
