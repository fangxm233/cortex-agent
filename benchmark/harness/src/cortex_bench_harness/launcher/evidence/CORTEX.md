...
| codex-subscription.offline-contract-passed.json | evidence | Binds Codex lifecycle and current CLI model proofs |
...
| pi-openai-codex-oauth.offline-contract-passed.json | evidence | Binds PI Codex lifecycle, runtime and scan proofs |
