...
| production_evidence_fixture.ts | fixture | Exports session-linked production bytes for host tests |
| test_production_host_finalization.py | test | Covers production evidence binding, admission and refusals |
