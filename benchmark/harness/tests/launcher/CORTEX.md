...
| production_evidence_fixture.ts | fixture | Exports real production bytes for host tests |
| test_production_host_finalization.py | test | Covers production evidence, admission and refusals |
