...
| test_capability_evidence.py | test | Verifies capability provenance and proof sources |
...
| test_live_handshake_permit.py | test | Verifies live bootstrap bounds and publish-safe diagnostics |
