...
| test_production_session.py | test | Proves production lifecycle, per-arm template and evidence injection, emitted evidence collection and stop |
| test_production_session_admission.py | test | Proves each arm's attested root POSTs through real sealed-environment exec |
