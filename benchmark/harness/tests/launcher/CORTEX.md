...
| test_vendor_agents.py | test | Verifies vendor setup, prompt transport, usage and caps |
...
| test_vendor_lifecycle_docker.py | test | Proves PI prompt transport and lifecycle in real Docker |
