...
| test_trial_admission.py | test | Proves container admission, credential refusal, and evidence |
| test_trial_admission_container.py | test | Proves the exact production boundary in Docker |
| fake_containment_claude.mjs | fixture | Probes the exact production container boundary |
