...
| test_production_session.py | test | Proves production lifecycle, emitted evidence collection and stop |
| test_production_session_admission.py | test | Drives the session's webhook POST through the real admitted sealed-environment exec |
