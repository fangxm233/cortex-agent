...
| test_real_agent_run.py | integration | Merges and validates a real fake-model agent-run |
...
| stub_trial.py | helper | Builds, merges, and audits the genuine container trial |
