...
| terminal-bench-2.1-deepseek-five-arm-r4-2026-08-22.json | evidence | Records the five-arm open-network run, rewards, deadline terminals, accounting availability, clean scans, revocation and artifact caveat |
...
| terminal-bench-2.1-full-pi-isolation-preflight-2026-08-22.json | evidence | Records per-task route and trace zero-provider preflight |
